...
construction/gvv ncert constr.pdf− Q.no.2.10
\end{lstlisting}
construct MORE  where $MO = 6, OR = 4.5, \angle M = 60\degree , \angle O = 105\degree$ and $\angle R = 105\degree$
\section{Solution}
...
\end{lemma}
\end{enumerate}
Where quadrilateral MORE has is constructed considering following parameters
...
if MORE is a quadrilateral,
Then

$$\angle M+\angle O+\angle R+\angle E= 360\degree$$
60+105+105+90 = 360\degree
